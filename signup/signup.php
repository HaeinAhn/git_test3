        ...
        <div class = "flex flex-col max-w-lg bg-gray-50 px-4 py-4 shadow rounded-lg">
          ...
          <form class="" action="../login/login.php" method="post">
            <div class="mb-1">
              ...
              <input id = "name" onkeyup = "printName()" class="border border-gray-400 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none 
              focus:shadow-outline" id="username" type="text" placeholder="" autocomplete="off">
            ...
            <div class="mb-1">
              ...
              <input id = "email" onkeyup='printEmail()' class="border border-gray-400 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none 
              focus:shadow-outline" id="username" type="text" placeholder="" autocomplete="off">
            ...
            <div class="mb-2">
              ...
              <input id = "pw" onkeyup = 'printPw()' class="border border-gray-400 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
